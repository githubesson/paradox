  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black text-green-400 font-mono">
      <Card className="w-[350px] border-green-500/30 bg-black">
        <CardHeader>
          <CardTitle className="text-2xl font-bold tracking-tighter text-green-400">PARADOX LOGIN</CardTitle>
          <CardDescription className="text-green-500/70">Enter your credentials to access the dashboard</CardDescription>
        </CardHeader>
